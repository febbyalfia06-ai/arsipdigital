...
// Ini adalah halaman read-only untuk sekretaris melihat arsip keluar
$query = mysqli_query($conn, "SELECT * FROM surat_keluar ORDER BY id DESC");
?>

<div class="header-action">
    <h2 class="page-title" style="margin-bottom:0;">Data Arsip Keluar</h2>
</div>
        ...
        <table>
            ...
            <tbody>
                ...
                if(mysqli_num_rows($query) > 0) {
                    ...
                    echo "<tr><td colspan='6' style='text-align:center;'>Belum ada arsip keluar.</td></tr>";
                }
                ?>
            </tbody>
        </table>
